...
def main(args):
    ...
    adata_h5 = sc.read_h5ad(data_fold)
    print(adata_h5)
    
    #count = adata_h5.X 
    features = adata_preprocess(adata_h5, min_cells=args.min_cells, pca_n_comps = min(args.Dim_PCA, adata_h5.shape[1] - 1))
